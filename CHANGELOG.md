...
* Update `types` property of `Subscription` schema allowing more than one event type per subscription by @eric-murray in https://github.com/camaraproject/Commonalities/pull/432
